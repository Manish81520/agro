...
<main>
	<div class="container center-align" style="width: 1000px;padding-top: 150px;">
	<ul class="collapsible">
    <li>
      <div class="collapsible-header container center-align btn-info yellow"><i class="material-icons">local_farm</i>FARMER</div>
    ...
    <li>
      <div class="collapsible-header container center-align btn-info yellow"><i class="material-icons">local_farm</i>BUYER</div>
      <div class="collapsible-body">
      	<div class="container center-align">
      		<form action="" method="POST">
      			<div class="row">
